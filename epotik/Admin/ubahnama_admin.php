                    ...
                    <div class="container-fluid">
                        ...
                        <form action="" method="post">
                            <div class="form-grup row">
                                <label for="id" hidden class="col-sm-2 col-from-label">ID</label>
                                <div class="col-sm-5">
                                    <input type="text" hidden class="form-control" name="id" id="id" value="<?php echo $row['id_admin']; ?>" required>
                                </div>
                            </div>
                            <div class="form-grup row">
